...
if (isset($_SESSION['login_success'])) {
    ...
    unset($_SESSION['login_success']); // remove so it won't repeat
}
?>
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    <a href="index.php" class="navbar-brand d-flex align-items-center">
                        <img src="../../dashboard/file/logo.jpg"
                        alt="bhumika jewellars logo"
                        height="50"
                        width="50"
                        class="rounded-circle border border-2 border-primary me-2">
                    <h1 class="text-primary display-6">Bhumi Jewellers</h1></a>
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    <?php 
                                                 ...
                                                 ?>
                                    <a href="shop.php?id=<?php echo $row[0];?>" class="dropdown-item"><?php echo $row[1];?></a>
