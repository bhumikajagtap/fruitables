...
if(isset($_POST['store']))
{
    ...
    $sql = "INSERT INTO registration (rname, email, contact, pass) VALUES ('$rname', '$email', '$contact','$password')";
            ...
            <ul id="sidebar_menu" class="metismenu">
                ...
                <li class="">
                    ...
                    <ul class="mm-collapse">
                        ...
                        <!-- <li><a href="register_table.php" class="active">Registration Tables</a></li> -->
                    ...
                    <div class="main-content">
                        ...
                        <div class="container-fluid px-lg-4">
                            <div class="row">
                                ...
                                <a href='register_table.php'>
                                    <button style='background:skyblue;color:black;padding:8px 15px;border:none'>Send</button>
                               </a>
                            </div>
                        </div>
                        <!-- Begin Page Content -->
