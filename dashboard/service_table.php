                            ...
                            <div class="row">
                                <div class="col-md-12 mt-lg-4 mt-4">
                                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                        <h1 class="h3 mb-0 text-gray-800">Service Table</h1>

                                    </div>
                                       <div style="text-align:right;">
                                            <a href="service_insert.php">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td><?php echo $result[0];?></td>
                                                                         ...
                                                                         <td><a href="service_update.php?id=<?php echo $result[0]; ?>">Update</a></td>
                                                                         <td><a href="service_delete.php?id=<?php echo $result[0]; ?>">Delete</a></td>
